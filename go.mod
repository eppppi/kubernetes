...
require (
	...
	github.com/eppppi/k8s-cp-dt v0.1.1
	...
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracehttp v0.0.0-00010101000000-000000000000
...
replace (
	github.com/eppppi/k8s-cp-dt => github.com/eppppi/k8s-cp-dt v0.1.8
